...
public class WillListPriorityQueue : MonoBehaviour
{
    static int size = 0;
    ...
    void Start()
    {
        ...
        //* H is the index
        //*values is the fCost
        NativeList<int> H = new NativeList<int>(Allocator.Temp);

        SetSize(0);
        //*Will be (gridMax.x * girdMax.y) -1
        SetMaxsize(49);
   ...
   // Method 4
    ...
    private void swap(int fpos, int spos, NativeList<int> H, int[] values)
    {
   ...
   private void minHeapify(int pos, NativeList<int> H, int[] values)
   {     
     if(!isLeaf(pos)){
    ...
    public void insert(int element, NativeList<int> H, int[] values)
    {
    ...
    public void print(int[] values, NativeList<int> H)
    {
    ...
    public void printTree(int[] values,NativeList<int> H)
    {
    ...
    public int remove(NativeList<int> H, int[] values)
    {
        int popped = H[FRONT];
        H[FRONT] = H[size--];
